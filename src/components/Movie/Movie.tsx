    ...
    return (
        <div className={styles.movieContainer}>
            <div className={styles.poster}>
                <img className={styles.posterImage} src={moviePoster} alt={movieData.alternativeName}></img>
                {movieData.rating.imdb > 0 ? 
                    <div className={styles.ratingSpanContainer}>
                        <span className={styles.ratingSpan}>{movieData.rating.imdb}</span>    
                    </div>
                    : null}
            </div>
